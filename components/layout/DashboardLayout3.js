import { ScaleIcon, CurrencyDollarIcon, WrenchIcon } from '@heroicons/react/24/outline'
import { BanknotesIcon, ChevronRightIcon } from '@heroicons/react/24/solid'
import Card from '@/components/cards/Card'

const accountCards = [
  { name: 'Rent collected', href: '#', icon: ScaleIcon, amount: '$30,659.45' },
  { name: 'Rent due', href: '#', icon: CurrencyDollarIcon, amount: '$3,600.00' },
  { name: 'Maintenance costs', href: '#', icon: WrenchIcon, amount: '$375.00' },
  // More items...
]
const transactions = [
  {
    id: 1,
    name: "Rent payment for 10 John's Cresent",
    href: '#',
    amount: '$1,000',
    currency: 'NZD',
    status: 'processing',
  ...
  {
    id: 2,
    name: "Rent payment for 50 Pakekuha Ave",
    href: '#',
    amount: '$830',
    currency: 'NZD',
    status: 'success',
...
export default function DashboardLayout3(props) {
      ...
      <div className="min-h-full">
          <main className="flex-1 pb-8">
            ...
            <div className="mt-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-lg leading-6 font-medium text-gray-900">Quick Links</h2>
                <div className="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                  {/* Card */}
                  {actionCards.map((card, index) => (
                    <Card 
                    card={actionCards[index]}
                    style={{
                      "aspectRatio": "sm:aspect-h-5 sm:aspect-w-9"
                    }}
                    />
                  ))}
                </div>
