...
const cards = {
  actionCards: [
    ...
    },
    {
      name: 'Your residents',
      description: 'Look at this stuff',
      imageSrc: 'https://cijtrwqqphdofjmlvaee.supabase.co/storage/v1/object/public/public/people/pexels-pixabay-220512.jpg',
      imageAlt: 'Wood table with porcelain mug, leather journal, brass pen, leather key ring, and a houseplant.',
      href: '#',
      color: 'to-pink-500',
      opacity: 'opacity-50',
...
export default function HomeownerDashboard({data, headerContent}) {
  ...
  return (
    <>
        <DashboardLayout2 headerContent={headerContent} cards={cards}/>
    </>
  )
}
