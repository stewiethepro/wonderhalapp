...
export default function BondManual({data, navData, headerContent, initialSession, sessionUser}) {
    const user = useUser();
...
BondManual.getLayout = getLayout;

BondManual.pageName = pages.resident.apply.book.name
BondManual.pageCategory = pages.resident.apply.book.category
