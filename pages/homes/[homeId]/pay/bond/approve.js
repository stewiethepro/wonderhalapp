...
export default function BondApprove({data, navData, headerContent, initialSession, sessionUser}) {
    const user = useUser();
...
BondApprove.getLayout = getLayout;

BondApprove.pageName = pages.resident.apply.book.name
BondApprove.pageCategory = pages.resident.apply.book.category
