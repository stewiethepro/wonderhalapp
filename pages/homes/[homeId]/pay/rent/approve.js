...
export default function RentApprove({data, navData, headerContent, initialSession, sessionUser}) {
    const user = useUser();
...
RentApprove.getLayout = getLayout;

RentApprove.pageName = pages.resident.apply.book.name
RentApprove.pageCategory = pages.resident.apply.book.category
