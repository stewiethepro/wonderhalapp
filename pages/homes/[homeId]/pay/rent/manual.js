...
export default function RentManual({data, navData, headerContent, initialSession, sessionUser}) {
    const user = useUser();
...
RentManual.getLayout = getLayout;

RentManual.pageName = pages.resident.apply.book.name
RentManual.pageCategory = pages.resident.apply.book.category
