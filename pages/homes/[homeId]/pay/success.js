...
export default function PaySuccess({data, navData, headerContent, initialSession, sessionUser}) {
    const user = useUser();
...
PaySuccess.getLayout = getLayout;

PaySuccess.pageName = pages.resident.apply.book.name
PaySuccess.pageCategory = pages.resident.apply.book.category
